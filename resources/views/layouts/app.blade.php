...
<body class="theme-primary menubar-light pace-done menubar-top" style="background-image: url('image/fondo.jpg'); background-attachment: fixed; background-size: 100% 100%; background-repeat: no-repeat;">
<!--============= start main area -->
